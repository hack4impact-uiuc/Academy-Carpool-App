...
class TripComponent extends React.Component {
  constructor(props) {
    ...
    this.state = { isHovering: false, cardSize: 'light' };
  }
  handleMouseHover() {
            ...
            <Card.Body>
              <Row>
                <Col xs={12} md={5}>
                  ...
                  {this.props.orgin.length < 15 && <Card.Title class="small">{this.props.orgin}</Card.Title>}
                </Col>
                <Col xs={12} md={2}>
                  <Card.Title>
              ...
              <Row>
                <Col xs={12} md={7}>
                  <Card.Subtitle>
                    <i class="far fa-calendar-alt"></i> {this.props.date}{' '}
                  </Card.Subtitle>
                  <Card.Text>
                    {' '}
                    {'\xa0\xa0\xa0\xa0\xa0'}
              ...
              {this.props.notes.length > 100 && <Card.Text>{this.props.notes.substring(0, 97)} ...</Card.Text>}
              {this.props.notes.length < 100 && <Card.Text> {this.props.notes}</Card.Text>}
