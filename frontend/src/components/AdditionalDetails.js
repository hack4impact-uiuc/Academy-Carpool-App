    ...
    return (
      ...
      <Card>
        <CardBody>
          ...
          <CardSubtitle>
            Venmo: {this.props.details.currentTrip.venmo}
          </CardSubtitle>
          <hr/>
          <div className = 'starttoend'>
            <b> {this.props.details.currentTrip.origin} &#8594;{this.props.details.currentTrip.destination} </b>
          </div>
          ...
          <div>
            ...
            <b>Seats Available: </b> {this.props.details.currentTrip.seats}<br />
            <b>Trunk Space: </b> {this.props.details.currentTrip.space}<br />
